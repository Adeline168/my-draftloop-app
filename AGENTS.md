...
DraftLoop — AI-powered organic content engine that turns raw ideas into platform-native, scored social post drafts with a repeatable drafting process.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "194386234+Adeline168@users.noreply.github.com"
  git config user.name "Adeline168"
  ```
